...
import { updateOnDemandApp } from '@/app/actions/on-demand';
...
export function UpdateOnDemandAppModal({ app }: { app: OnDemandApp }) {
  const [state, dispatch] = useFormState(updateOnDemandApp, {
    message: '',
    status: '',
    errors: {},
    onDemandApplicationID: app.id,
  });
  const [isOpen, setIsOpen] = useState(false);
  const [appImage, setAppImage] = useState<string | undefined>(app.icon || '');
